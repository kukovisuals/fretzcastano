...
/*
    ...
    ▓  There is a picture on pinterest about an 
    ▓  Activated T lymphocyte shape which I tried to do.
    ▓  Then I grab the Hash and color idea from iq shader
    ▓  https://www.shadertoy.com/view/4sB3D1
    
    ▓  Aliasing with less blur gets worst
